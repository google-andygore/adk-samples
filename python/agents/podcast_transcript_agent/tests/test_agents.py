...
async def test_run_with_txt():
        ...
        content = types.Content(
            parts=[
                types.Part(text="Generate podcast from this document. Podcast host name is Charlotte, expert's name is Dr Joe Sponge"),
                types.Part(
                ...
                if event.content and event.content.parts:
                    for part in event.content.parts:
                        if part.text:
                            ...
                            if "metadata" in data and "duration_seconds" in data["metadata"]:
